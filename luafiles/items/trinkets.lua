...
function _Stillbirth:chainmailUpdate(entity, dmg_amount, dmg_flag, dmg_src, dmg_countdown)
...
_Stillbirth:AddCallback(ModCallbacks.MC_ENTITY_TAKE_DMG, _Stillbirth.chainmailUpdate, EntityType.ENTITY_PLAYER)
--]]
--[[
