...
function _Stillbirth:ReplaceBlackCandleCostume(player, cacheFlag)
	if player:HasCollectible(CollectibleType.COLLECTIBLE_BLACK_CANDLE) and not g_vars.black_candle_replaced then
		player:TryRemoveCollectibleCostume(CollectibleType.COLLECTIBLE_BLACK_CANDLE, false)
		player:AddNullCostume(Isaac.GetCostumeIdByPath("gfx/characters/blackcandle.anm2"))
		g_vars.black_candle_replaced = true
	end
end
_Stillbirth:AddCallback(ModCallbacks.MC_EVALUATE_CACHE, _Stillbirth.ReplaceBlackCandleCostume)
