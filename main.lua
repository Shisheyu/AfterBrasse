...
--~ 		Isaac.RenderText("", 5, 250, 255, 0, 0, 255)
	...
	Items =	{
					...
					DadsWhip_i = Isaac.GetItemIdByName("Dad's Whip"),
					--zodiac_capricorn2_i = Isaac.GetItemIdByName("Zcapri2")
					--babyBlender_i = Isaac.GetItemIdByName("Baby Blender"),
					--crickets_leash_i = Isaac.GetItemIdByName("Cricket's Leash"),
					--crickets_toys_i = Isaac.GetItemIdByName("Cricket's Toys")
				}
	...
	CustomEntities =	{
								...
								BananaEntity_Variant = Isaac.GetEntityVariantByName( "Explosive Banana" ),
	...
	GiantBooks.goldenidol:Load("gfx/ui/giantbook/goldenidol_giant.anm2", true)
	frictionEntities = {}
	velocityEntities = {}
...
--]]
	...
	local g_vars = [[
		local g_vars =	{ 	-- Here goes the global variables( that will be saved )
								...
								translaser_replacedSpritesheet = false,
								transcricket_replacedSpritesheet = false,
								transbubbles_replacedSpritesheet = false,
								transzodiac_replacedSpritesheet = false,
								framecount_stop = -1,
								freezeentities_init = 0
							}
		return g_vars
	]]
