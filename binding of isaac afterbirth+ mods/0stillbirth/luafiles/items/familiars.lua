...
function _Stillbirth:onGeminiUnleashUpdate(fam)
	...
	sprite:Render(fam.Position, empty_vec, empty_vec)
	sprite:Update()
end

_Stillbirth:AddCallback(ModCallbacks.MC_FAMILIAR_INIT, _Stillbirth.onGeminiUnleashedInit)
_Stillbirth:AddCallback(ModCallbacks.MC_FAMILIAR_UPDATE, _Stillbirth.onGeminiUnleashUpdate)
